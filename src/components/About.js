      ...
      <div className="about">
        <div className="bio-wrapper">
          ...
          <div>
            <h2>About Me</h2>
            <p className="select">
              I'm a Full Stack Developer residing in Abbotsford, British
              Columbia. I strive to make clean, responsive, and intuitive
              websites and user interfaces while maitaining code which is easy
              to dive into!
              ...
              or{" "}
              <Link to="/contact" className="bio-link">
                drop me a line{" "}
              </Link>
        ...
        <div className="skills">
          <div className="skill">
            <div className="skill-title">CSS/SCSS</div>
            <div className="skill-percent">
              <div
                className="skill-percent-fill"
                style={{ width: "90%" }}
              ></div>
            </div>
            <span>90%</span>
